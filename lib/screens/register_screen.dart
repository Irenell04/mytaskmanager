            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Create a free account to sync tasks',
                    textAlign: TextAlign.center,
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text("CONFIRM PASSWORD", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.grey.shade600, letterSpacing: 0.5)),
                  ),
                  const SizedBox(height: 6),
                  TextFormField(
